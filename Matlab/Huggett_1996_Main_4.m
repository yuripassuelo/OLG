...
writetable(Tabela_Resumo,'Results/ResultadosPrincipais_4.txt')
...
writetable(Tabela_Secundaria,'Results/ResultadosSecundarios_4.txt')
...
exportgraphics(gcf,'Plots/Plot_Geral_4.pdf','ContentType','vector')
...
exportgraphics(gcf,'Plots/Plot_Geral_4_v2.pdf','ContentType','vector')
...
exportgraphics(gcf,'Plots/Plot_Geral_4_v3.pdf','ContentType','vector')
...
exportgraphics(gcf,'Plots/Plot_Geral_4_v4.pdf','ContentType','vector')


writematrix( kprimeHistM1 , 'Results/Data/Matriz_n1_4.dat')
writematrix( kprimeHistM2 , 'Results/Data/Matriz_n2_4.dat')
writematrix( kprimeHistM3 , 'Results/Data/Matriz_n3_4.dat')

...
2. Tabua de Mortalidade Social Security (2021)
...
writetable(Tabela_Resumo,'Results/ResultadosPrincipais_3.txt')
...
writetable(Tabela_Secundaria,'Results/ResultadosSecundarios_3.txt')
...
exportgraphics(gcf,'Plots/Plot_Geral_3.pdf','ContentType','vector')
...
exportgraphics(gcf,'Plots/Plot_Geral_3_v2.pdf','ContentType','vector')
...
exportgraphics(gcf,'Plots/Plot_Geral_3_v3.pdf','ContentType','vector')
...
exportgraphics(gcf,'Plots/Plot_Geral_3_v4.pdf','ContentType','vector')
...
writematrix( kprimeHistM1 , 'Results/Data/Matriz_n1_3.dat')
writematrix( kprimeHistM2 , 'Results/Data/Matriz_n2_3.dat')
writematrix( kprimeHistM3 , 'Results/Data/Matriz_n3_3.dat')
